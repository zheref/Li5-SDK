...
@property (nonatomic, strong) id<UserProfileViewControllerPanTargetDelegate> profileInteractor;
...
- (void)viewDidLoad
{
    ...
    self.profileInteractor = [[UserProfileDynamicInteractor alloc] initWithParentViewController:self];
    screenEdgePanGestureRecognizer = [[UIScreenEdgePanGestureRecognizer alloc] initWithTarget:self.profileInteractor action:@selector(userDidPan:)];
    [screenEdgePanGestureRecognizer setEdges:UIRectEdgeTop];
    [screenEdgePanGestureRecognizer setDelegate:self];
