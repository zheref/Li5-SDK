...
@implementation Li5Constants

NSString * const kLoginSuccessful = @"LoginSuccessful";
NSString * const kLoginFailed = @"kLoginFailed";
NSString * const kLogoutSuccessful = @"kLogoutSuccessful";
NSString * const kLogoutFailed = @"kLogoutFailed";
NSString * const kCategoriesUpdateSuccessful = @"kCategoriesUpdateSuccessful";
